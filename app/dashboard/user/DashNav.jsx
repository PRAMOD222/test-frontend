...
const DashNav = () => {
  return (
    <div>
        <div className="bg-neutral-800 min-h-screen h-full p-8 w-[20vw]">
            ...
            <div className='links my-8 flex flex-col gap-8'>
                <Link href={"/dashboard/user"}>
                    <h2 className='flex items-center gap-2 p-4 bg-white rounded-md font-semibold text-gray-700 hover:text-white hover:bg-[#c19f5f] transition-all duration-300'> <RxDashboard className='inline text-xl' />Address</h2>
                </Link>
